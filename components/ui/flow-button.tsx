  ...
  return (
    <div className={cn('ring-primary/60 relative isolate w-fit overflow-hidden rounded-lg ring-2', className)}>
      <Button
        ...
        asChild={asChild}
        className={cn(
          'hover:bg-black relative rounded-lg border border-transparent bg-clip-padding duration-500 bg-black',
  ...
  return (
    <div className={cn('ring-secondary/60 relative isolate w-fit overflow-hidden rounded-lg ring-2', className)}>
      <Button
        ...
        asChild={asChild}
        className={cn(
          'hover:bg-black relative rounded-lg border border-black bg-clip-padding duration-500 text-shadow-xs',
          size === 'lg' && 'text-base has-[>svg]:px-6',

          // After - Border gradient effect with rotation
          'after:absolute after:-inset-30 after:-z-1 after:rounded-[inherit] after:border bg-black after:border-[inherit] after:bg-origin-border after:mask-exclude after:mask-clip-content after:transition-transform after:duration-500 after:[mask:linear-gradient(black,black),linear-gradient(black,black)]',
